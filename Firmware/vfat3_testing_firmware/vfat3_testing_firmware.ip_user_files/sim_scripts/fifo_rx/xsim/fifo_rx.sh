...
#
# Generated by Vivado on Tue May 16 12:03:57 +0200 2017
# IP Build 1681267 on Mon Oct 10 21:28:31 MDT 2016 
#
# usage: fifo_rx.sh [-help]
# usage: fifo_rx.sh [-lib_map_path]
# usage: fifo_rx.sh [-noclean_files]
# usage: fifo_rx.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "fifo_rx.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_2 -L work -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_rx work.fifo_rx work.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim fifo_rx -key {Behavioral:sim_1:Functional:fifo_rx} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_rx.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_rx.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fifo_rx.sh -help\" for more information)\n"
    exit 1
  fi
