...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xpm -L work -L unisims_ver -L unimacro_ver -L secureip --snapshot clk_wiz_0 work.clk_wiz_0 work.glbl -log elaborate.log
}
