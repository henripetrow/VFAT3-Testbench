...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L work -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ser_8 work.ser_8 work.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim ser_8 -key {Behavioral:sim_1:Functional:ser_8} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ser_8.wdb xsim.dir)
