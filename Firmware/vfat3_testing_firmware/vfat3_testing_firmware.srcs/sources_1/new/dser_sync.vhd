...
architecture rtl of dser_sync is
	...
	constant F1 : std_logic_vector(cmd_w - 1 downto 0) := X"00"; -- change to 7e for vfat3 filler, 00 only for loopback
	constant F2 : std_logic_vector(cmd_w - 1 downto 0) := X"ff"; -- change to 81 for vfat3 filler, ff only for loopback
