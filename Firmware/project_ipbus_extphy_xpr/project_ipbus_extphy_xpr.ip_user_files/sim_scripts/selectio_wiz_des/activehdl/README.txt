...
#
# Generated by export_simulation on Wed Mar 15 09:51:06 +0100 2017
#
################################################################################
...
switch to the './selectio_wiz_des.sh' script.

./selectio_wiz_des.sh -reset_run
...
./selectio_wiz_des.sh -noclean_files

For more information on the script, please type './selectio_wiz_des.sh -help'.
