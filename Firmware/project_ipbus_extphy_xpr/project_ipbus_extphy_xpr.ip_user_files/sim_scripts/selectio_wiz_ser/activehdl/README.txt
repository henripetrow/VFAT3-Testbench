...
#
# Generated by export_simulation on Wed Mar 15 09:39:09 +0100 2017
#
################################################################################
...
switch to the './selectio_wiz_ser.sh' script.

./selectio_wiz_ser.sh -reset_run
...
./selectio_wiz_ser.sh -noclean_files

For more information on the script, please type './selectio_wiz_ser.sh -help'.
