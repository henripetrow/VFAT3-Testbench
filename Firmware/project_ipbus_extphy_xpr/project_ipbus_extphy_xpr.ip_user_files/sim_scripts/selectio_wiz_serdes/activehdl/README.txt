...
#
# Generated by export_simulation on Wed Apr 12 17:49:01 +0200 2017
#
################################################################################
...
switch to the './selectio_wiz_serdes.sh' script.

./selectio_wiz_serdes.sh -reset_run
...
./selectio_wiz_serdes.sh -noclean_files

For more information on the script, please type './selectio_wiz_serdes.sh -help'.
