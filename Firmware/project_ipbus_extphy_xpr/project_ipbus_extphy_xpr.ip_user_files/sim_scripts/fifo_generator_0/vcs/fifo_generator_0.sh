...
#
# Generated by Vivado on Mon Mar 06 18:17:03 +0100 2017
...
compile()
{
  ...
  vlogan -work work $vlogan_opts +v2k \
    "$ref_dir/../../../../../../../../../Dropbox/ULB/MA2/Memoire/Github/VFAT3-Testbench/Firmware/project_ipbus_extphy_xpr/project_ipbus_extphy_xpr.srcs/sources_1/ip/fifo_generator_0/sim/fifo_generator_0.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts work.fifo_generator_0 work.glbl -o fifo_generator_0_simv
}
