...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L work -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_0 work.clk_wiz_0 work.glbl -log elaborate.log
}
