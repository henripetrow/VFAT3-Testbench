...
/* synthesis syn_black_box black_box_pad_pin="rst,wr_clk,rd_clk,din[31:0],wr_en,rd_en,dout[31:0],full,almost_full,wr_ack,empty,almost_empty" */;
  input rst;
  input wr_clk;
  input rd_clk;
  input [31:0]din;
