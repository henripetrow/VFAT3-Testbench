...
HD_PWD='C:/Users/Jason/Dropbox/ULB/MA2/Memoire/Github/VFAT3-Testbench/Firmware/project_ipbus_extphy_xpr/project_ipbus_extphy_xpr.runs/selectio_wiz_serdes_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log selectio_wiz_serdes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source selectio_wiz_serdes.tcl
