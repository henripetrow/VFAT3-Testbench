...
proc dofile {f} {
	...
	foreach f_line [split $files "\n"] {
		...
		set arg2 [lindex $l 2]
		if {$cmd != "ghdl"} {
			set f_list [glob ~/Dropbox/ULB/MA2/Memoire/Vivado/ipbus/$arg1]
		} else {
...
set libs ""
dofile ~/Dropbox/ULB/MA2/Memoire/Vivado/ipbus/ipbus/firmware/example_designs/projects/demo_kc705_basex/ise14/file_list
