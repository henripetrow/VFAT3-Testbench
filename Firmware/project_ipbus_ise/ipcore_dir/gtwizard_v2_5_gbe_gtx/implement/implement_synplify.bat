...
ngdbuild -uc ..\..\example_design\gtwizard_v2_5_gbe_gtx_exdes.ucf -p xc7k325t-ffg900-2 gtwizard_v2_5_gbe_gtx_exdes.edf gtwizard_v2_5_gbe_gtx_exdes.ngd
...
ECHO 'Running NGD'
map -p xc7k325t-ffg900-2 -o mapped.ncd gtwizard_v2_5_gbe_gtx_exdes.ngd
