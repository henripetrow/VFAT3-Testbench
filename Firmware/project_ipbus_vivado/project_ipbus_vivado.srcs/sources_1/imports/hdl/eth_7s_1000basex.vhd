...
architecture rtl of eth_7s_1000basex is
    ...
    signal tie_to_ground_vec :std_logic_vector(39 downto 0);

begin

	tie_to_ground_vec <= x"0000000000";
	...
	phy: entity work.gig_eth_pcs_pma_basex_v15_1
		port map(
			...
			gmii_rx_er => gmii_rx_er,
			gmii_isolate => open,
			configuration_vector => tie_to_ground_vec(4 downto 0),
			status_vector => open,
			reset => rsti,
			signal_detect => sig_det,
			gt0_qplloutclk_in => tie_to_ground_vec(0),
			gt0_qplloutrefclk_in => tie_to_ground_vec(0)
		);
